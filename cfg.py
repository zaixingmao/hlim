...
def bins(ch):
    ...
    m2015  = [85, 100, 110, 120, 130, 140, 150, 160, 170, 180, 190, 200, 225, 250, 275, 300, 400, 600, 900]
    m2015_900  = m2015 + [1200]
    m2015_1200 = m2015_900 + [1700]
    # m9  = [90, 125, 150, 175, 200, 250, 300, 400, 600, 900, 1200]

    a600  = [165, 200, 225, 250, 275, 300, 400, 600, 900]
    a700  = [165, 200, 225, 250, 275, 300, 400, 600, 700, 900]
    a800  = [165, 200, 225, 250, 275, 300, 400, 600, 800, 1000]
    a900  = [165, 200, 225, 250, 275, 300, 400, 600, 900, 1200]

    b700  = [165, 200, 225, 250, 275, 300, 400, 550, 700, 900]
    b750  = [165, 200, 225, 250, 300, 350, 450, 600, 750, 900]

    c700  = [200, 225, 250, 275, 300, 400, 550, 700, 900]
    c750  = [200, 225, 250, 300, 350, 450, 600, 750, 900]

    return {"em": m2015_1200,
            "et": m2015_900,
            "mt": m2015_1200,
            "tt": c750,
            }[ch]
